const projects = [
  ...
  image: '/images/senSavvyLogo.png',
    links: [{ href: 'https://sensavvy.org/', label: 'Website' }, { href: 'https://instagram.com/sen.savvy/', label: 'Insta' }],
    cards: [
  { id: 'ss-1', title: 'Elevator Pitch', thumbnail: '/images/pitch.png', href: 'https://www.loom.com/share/cf69036eb3b346f78be8838875244143?sid=b7e06f98-a772-4d68-b5c1-5c6defc31c84' },
  ...
  meta: { year: '2022-Present', tech: [] },
    cards: [
      { id: 'art-1', title: 'Visual Autobiography', thumbnail: '/images/visual_autobiography.png', full: '/images/visual_autobiography.png', statement: 'An exploration of texture and light.' , href: '#'},
      { id: 'art-2', title: 'Self Portrait', thumbnail: '/images/selfPortrait.jpeg', full: '/images/selfPortrait.jpeg', statement: 'Thought I\'d play around with colored pencils.', href: '#'},
    { id: 'art-3', title: 'Sister Portrait', thumbnail: '/images/sisterPortrait.png', full: '/images/sisterPortrait.png', statement: 'Inspired by "one-line" art.', href: '#'},
    { id: 'art-4', title: 'My Existence', thumbnail: '/images/myExistence.jpeg', full: '/images/myExistence.jpeg', statement: 'A study in muted palettes and composition.', statementLink: { href: 'https://docs.google.com/document/d/1DSlzIh0-JLh2t6RNipRRlDYiaGWAEYdMfIO1McD45HA/edit?usp=sharing', text: 'View the full artist statement here.' }, href: '#'},
    { id: 'art-5', title: 'Painted Flower', thumbnail: '/images/finished_flower.png', full: '/images/finished_flower.png', statement: 'Painted in Photoshop.', href: '#'},
      { id: 'art-6', title: 'Fish', thumbnail: '/images/Fish.png', full: '/images/Fish.png', statement: 'Just a little experimenting with shapes.', href: '#'},
    ],
  },
];
