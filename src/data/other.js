const other = [
  ...
  },
  {
    ...
    icon: '',
    cards: [
  { id: 'tr-1', title: 'Trip 1', images: ['/images/profile.jpg','/images/profile.jpg'] , statement: 'A week in the mountains.'},
  { id: 'tr-2', title: 'Trip 2', images: ['/images/profile.jpg','/images/profile.jpg'], statement: 'Coastal sketches.'},
    ],
  },
]
